            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  This action cannot be undone. Please review the products below.
                </p>
              </div>
            </div>
            <button
              ...
              {dealerProducts.length > 0 && (
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">
                    Your Products in this Category ({dealerProducts.length})
                  </h3>
                    ...
                    {dealerProducts.map((product) => (
                      <div key={product.product_id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                        <div className="flex items-start space-x-3">
                             ...
                             <div className={`w-12 h-12 rounded-lg bg-gray-200 flex items-center justify-center ${product.image_1 && getImageSrc(product.image_1) ? 'hidden' : ''}`}>
